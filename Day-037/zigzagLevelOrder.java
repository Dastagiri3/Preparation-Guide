...
public class Main {
    public static void main(String[] args) {
        ...
        // Example 1: [3,9,20,null,null,15,7] -> [[3],[20,9],[15,7]]
        TreeNode root1 = Solution.buildTree(new Integer[]{3, 9, 20, null, null, 15, 7});
        System.out.println("Example 1: " + sol.zigzagLevelOrder(root1));

        // Example 2: [1] -> [[1]]
        TreeNode root2 = Solution.buildTree(new Integer[]{1});
        System.out.println("Example 2: " + sol.zigzagLevelOrder(root2));
